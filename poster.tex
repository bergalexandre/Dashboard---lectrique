...
\begin{itemize}
    ...
    \begin{enumerate}
        \item Signature du protocole d'assemblage batterie V0
        \item Design attache moteur transmission
        % \item Onduleur fonctionnel
        % \item Fin imminente des cours de concentration
    \end{enumerate}
\end{itemize}
...
\begin{center}
    \includegraphics[width=\linewidth]{img/cashflow_20220328.pdf}
\end{center}
...
\headerbox{Citation de la semaine}{name=citation,column=0,row=0, span=3,below=cashflow}{
    \vspace{0.1cm}
    \textit{"The bad news is time flies. The good news is you're the pilot."} --Michael Altshuler
