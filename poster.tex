...
\textbf{QUOTE} : If you are \textit{PERSISTENT} you will get it. If you are \textit{CONSISTENT} you will keep it.
}
...
\begin{itemize}
    ...
    \begin{enumerate}
        \item Chip BMS et active balancing
        \item Repo git pour batterie pack et BMS
    \end{enumerate}
\end{itemize}
...
\headerbox{Objectifs semaine prochaine}{name=objectifs_prochain,column=2,span=1,below=risques}{
{
    ...
    \begin{enumerate}
        \item Terminer CAD préliminaire pour la revue de conception (MEC / ELEC).
    \end{enumerate}
    \item \textbf{Contrôle moteur et Onduleur :}
    \begin{enumerate}
        \item Design review de la schématique et simulation du circuit
    \end{enumerate}
    \item \textbf{Batterie BMS et Instrumentation :}
    \begin{enumerate}
        \item Finaliser le design des convertisseurs
        \item Design du BMS avec la chip intégrée
    \end{enumerate}
    \item \textbf{Simulateur et Transferts Thermiques :}
    \begin{enumerate}
        \item Supporter l'équipe info pour formules mathématiques Transmission et Battery Pack
        \item Fournir l'équipe info avec formules mathématiques pour échanges thermiques
    \end{enumerate}
    \end{itemize}
