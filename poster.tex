...
\begin{itemize}
    ...
    \begin{enumerate}
        \item Assemblage bloc batterie V0
...
\begin{center}
    \includegraphics[width=\linewidth]{img/cashflow_20220404.pdf}
\end{center}
...
\headerbox{Citation de la semaine}{name=citation,column=0,row=0, span=3,below=cashflow}{
    \vspace{0.1cm}
    \textit{"Imagination is the only weapon in the war against reality."} --Lewis Carroll
