...
\headerbox{Citation de la semaine}{name=citation,column=0,row=0, span=3,below=risques}{
    \vspace{0.1cm}
    \textit{“Concentrate all your thoughts upon the work at hand. The sun’s rays do not burn until brought to a focus.”} --Alexander Graham Bell
