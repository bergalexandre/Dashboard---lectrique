...
\begin{itemize}
    ...
    \begin{enumerate}
        \item Modélisation numérique moteur et transmission %Ne pas modifier is still good
        \item Revue de conception et commande PCB V1 BMS
        \item Cellules Calogy
        \item Rappel Design Review BRP vendredi 25 février%Ne pas modifier is still good
...
\begin{center}
    \includegraphics[width=\linewidth]{img/cashflow_20220211.pdf}
\end{center}
\vspace{-25\baselineskip}
}

\headerbox{Citation de la semaine}{name=citation,column=0,row=0, span=3,below=cashflow}{
 \textit{"In the midst of chaos, there is also opportunity."} --Sun-Tzu 
