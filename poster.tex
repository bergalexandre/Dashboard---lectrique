...
\begin{itemize}
    ...
    \begin{enumerate}
        \item Assemblage onduleur
        \item Semaine sans APP
        \item Retour avancements Mot./Trans. + Rappel cible intégration véhicule 3-4 Oct.
    \end{enumerate}
\end{itemize}
...
\headerbox{Citation de la semaine}{name=citation,column=0,row=0, span=3,below=risques}{
    \vspace{0.1cm}
    \textit{“Continuous effort---not strength or intelligence---is the key to unlocking our potential.”} --Winston Churchill
