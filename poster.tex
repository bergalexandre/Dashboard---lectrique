...
\begin{itemize}
    ...
    \begin{enumerate}
        \item Essais routiers Centre des foires 22 novembre
        \item Assemblage d'un onduleur de secours
        \item Retour véhicule peinture jeudi 17 novembre
    \end{enumerate}
\end{itemize}
...
\headerbox{Citation de la semaine}{name=citation,column=0,row=0, span=3,below=risques}{
    \vspace{0.1cm}
    \textit{“Engineers like to solve problems. If there are no problems handily available, they will create their own problems.”} --Scott Adams
