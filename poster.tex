...
\begin{itemize}
    ...
    \begin{enumerate}
        \item Protocole d'assemblage batterie V0 
        \item Validation choix conception moteur
...
\begin{center}
    \includegraphics[width=\linewidth]{img/cashflow_20220321.pdf}
\end{center}
...
\headerbox{Citation de la semaine}{name=citation,column=0,row=0, span=3,below=cashflow}{
    \vspace{0.1cm}
    \textit{"If everything seems under control, you're just not going fast enough."} --Mario Andretti
