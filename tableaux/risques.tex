\begin{tabularx}{\linewidth}{
    ...
    Vérification des solutions analytiques & Utilisation de MatLab & Pas avoir de solution pour vérifier la FEA & MOYEN\\\hline
    Manque de temps dû à la fin de session & Gestion temps et priorités & Diminution de la qualité & HAUT\\\hline
    Les composantes du circuit BMS ne répondent pas aux besoins & Révision par un pair & Retard du BMS & FAIBLE\\\hline
    Le moteur prend trop de temps & Mettre plus d'heures ou ajouter des membres au système & Retard du moteur & MOYEN\\\hline
  \end{tabularx}
